...
//    }
    ...
    public int getCount() {
        ...
        System.out.println("size" + day_string.size());
        return day_string.size();
//        return ActivityCalendar.point_id.size();
    }
...
//        System.out.println("Test" + ActivityCalendar.point_date.get(position));
//
//
//        String date = ActivityCalendar.point_date.get(position);
